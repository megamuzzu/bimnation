...
class Base_model extends CI_Model{
    ...
    */    
    ...
    public function where_update_data($table_name='',array $where_data,array $set_data)
    {
       
        $this->db->where($where_data);
        if(isset($table_name) && !empty($table_name))
        {
            $this->db->update($table_name, $set_data);    
        }else
        {
    ...
    public function where_delete_data($table_name='',array $where_data)
    {
